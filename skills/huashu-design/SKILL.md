---
name: huashu-design
description: 用HTML做高保真设计产出的一体化能力——交互原型、幻灯片、动画Demo、App mockup、设计变体探索、品牌发布动画、带解说长视频。触发词：做原型、设计Demo、交互原型、动画、幻灯片、app原型、iOS mockup、设计变体、推荐风格、设计方向、好不好看、评审、导出MP4/GIF、voiceover动画。
---
